...
import todoListsReducer, { ITodoListDomain, todoListReducers } from "./todoListsReducer/todoListsReducer";
...
test("ids should be equals", () => {
  ...
  const action = todoListReducers.addTodoListAC(newTodoList);
